...
if CUDNN_PATH then
    ...
    local libnames = {'libcudnn.so.7', 'libcudnn.7.dylib', 'cudnn64_5.dll'}
    local ok = false
    for i=1,#libnames do
...
if cudnn.version < 7003 or cudnn.version >= 8000 then
   error('These bindings are for CUDNN 7.x (7003 <= cudnn.version > 8000) , '
